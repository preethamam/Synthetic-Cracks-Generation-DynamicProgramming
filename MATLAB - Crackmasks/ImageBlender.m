...
elseif isunix
    synCrackGTFolder = '/media/preethamam/Utilities-HDD/OneDrive/Team Work/Team RoboCRACK/Program/2020-01-05/data/Synthetic/Dataset III (SDNET2018)/Pixel Labels/GT/crack';    
    overlayCrackFolder = '/media/preethamam/Utilities-HDD/OneDrive/Team Work/Team RoboCRACK/Program/2020-01-05/data/Synthetic/Dataset III (SDNET2018)/crack';
elseif ispc
    synCrackGTFolder = 'U:\Project MegaCRACK-RoboCRACK\Real World Data\Hybrid Paper\Synthetic Crack Blending';
else
    disp('Platform not supported')
end
