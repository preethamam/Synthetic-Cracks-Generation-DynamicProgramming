...
% is empty)
%--------------------------------------------------------------------------
texturefeature_inpstruct.originaldata_folders    = {'Cracks_small_dataset', 'Non-cracks_small_dataset'};

%--------------------------------------------------------------------------
% Data folder path
%--------------------------------------------------------------------------
texturefeature_inpstruct.folderpath_texture = '..\..\data\Testing\Dataset V';
...
texturefeature_inpstruct.matFilename = 'ZZZ_texture_testing_Dataset_V.mat';
...
% Jahanshahi Inputs
%--------------------------------------------------------------------------
jahan_inpstruct.nmin = 1; %pixel-1; %1;     %1 | 40  % minimum crack size in pixel (after transformation)
jahan_inpstruct.nmax = 200; %pixel-25; %200;      % maximum crack size in pixel (after transformation)
jahan_inpstruct.nstep = 5; %pixel-2; %5
...
% File details
%--------------------------------------------------------------------------
textFileName = 'pp_hybrid_morpho_marathon_CDLN';  % use custom name and .txt to bypass serial incrementer
...
hybrid_inpstruct.timeFilename = 'ZZZ_DS5r_timestamps_June092021';
...
elseif isunix
    hybrid_inpstruct.filesavepath            = '/media/preethamam/Utilities';
elseif ispc
    hybrid_inpstruct.filesavepath            = 'D:\';
else
    disp('Platform not supported')
end
hybrid_inpstruct.storeFolderName         = 'Crackoutputs hybrid-morpho DS CDLN';
...
elseif isunix
    hybrid_inpstruct.PixLabelsFolder = '/media/preethamam/Utilities-SSD/Xtreme_Programming/Preetham/MATLAB/Dataset Predicts/DS 5 Pixel Labels';
elseif ispc
    hybrid_inpstruct.PixLabelsFolder = 'D:\Xtreme_Programming\Preetham\MATLAB\Dataset Predicts\DS CDLN Pixel Labels';
else
    disp('Platform not supported')
end
...
if (strcmp(hybrid_inpstruct.searchType,'single_search'))
    ...
    hybrid_Frangi_gridsearch.frangiopt.FrangiScaleRange2 = 15; %pixel width 9.7423; %15; %[3 10]
    ...
    hybrid_Frangi_gridsearch.frangiopt.FrangiScaleRange2 = 15;
...
if (strcmp(hybrid_inpstruct.searchType,'single_search'))    
    ...
    %--------------------------------------------------------------------------
    % Stage I and Stage II
    hybrid_MFAT_gridsearch.aniso_num_iter1 = 0; %485; %85; %:10:100; %0:5:10;%:100; %0:100; %[5 5]  % 15 [5 good] 85
    ...
    %--------------------------------------------------------------------------
    % MFAT filter options
    hybrid_MFAT_gridsearch.MFAToptions.sigmas1       = 0.7181;  % 1
    hybrid_MFAT_gridsearch.MFAToptions.sigmas2       = 12.4106; % 12.5  [0.782174183815890,0.781857711412556,0.775797432964799] [0.784728063849959,0.781899268844155,0.777392362164455]
    hybrid_MFAT_gridsearch.MFAToptions.sigmasScaleRatio = 0.25;
    hybrid_MFAT_gridsearch.MFAToptions.spacing       = 0.39; %0.4, 0.45 0.39
    hybrid_MFAT_gridsearch.MFAToptions.tau           = 0.25; 
    hybrid_MFAT_gridsearch.MFAToptions.tau2          = 0.5; 
    hybrid_MFAT_gridsearch.MFAToptions.D             = 0.5; %0.85
else
    %--------------------------------------------------------------------------
    ...
    hybrid_MFAT_gridsearch.MFAToptions.spacing       = 0.35 : 0.01 : 0.45;
...
switch hybrid_inpstruct.classfier_trained_model
    case 'million_unique_all'
        ...
        hybrid_inpstruct.montage_dir = {'CDLN', '01'};
    case 'unique_100000'
        ...
        hybrid_inpstruct.montage_dir = {'CDLN', '02'};
    case 'real_world'
        ...
        hybrid_inpstruct.montage_dir = {'CDLN', '03'};
    ...
    case 'real_world_augmented_only'
        ...
        hybrid_inpstruct.montage_dir = {'CDLN', '04'};
    ...
    case 'real_world+augmented'
        ...
        hybrid_inpstruct.montage_dir = {'CDLN', '05'};
    ...
    case 'real_world+augmented+synthetic'
        ...
        hybrid_inpstruct.montage_dir = {'CDLN', '06'};
    otherwise
