...
% Callback
MainInputs_Training_Realworld_Dataset;
...
if (inpstruct.flagswitch && ...
    ...
    % Images        
    inpstruct.real_crack = real_crack_Imgs;
...
%
realworld_train_FML = load('ZZZ_FeatMAT_5JahanFeat_Labels_Realworld_Traincracks_AllDS.mat');
...
save_Train_matfile = 'ZZZ_FeatMAT_5JahanFeat_hessian_Realworld_Train_crack_noncrack.mat';
save_Val_matfile = 'ZZZ_FeatMAT_5JahanFeat_hessian_Realworld_Val_crack_noncrack.mat';
...
realworld_train_FML_cnc = load('ZZZ_FeatMAT_5JahanFeat_hessian_Realworld_Train_crack_noncrack.mat');
saveUnqMatfile = 'ZZZ_Train_5JahanFeatMatLabels_hessian_Realworld_Train_AllDS.mat';
...
realworld_val_FML_cnc = load('ZZZ_FeatMAT_5JahanFeat_hessian_Realworld_Val_crack_noncrack.mat');
saveUnqMatfile = 'ZZZ_Train_5JahanFeatMatLabels_hessian_Realworld_Val_AllDS.mat';
...
if (inpstruct.PrepareData2Classifier)
    fmltTrain = load('ZZZ_Train_5JahanFeatMatLabels_hessian_Realworld_Train_AllDS.mat');
    fmltVal = load('ZZZ_Train_5JahanFeatMatLabels_hessian_Realworld_Val_AllDS.mat');
    ...
    inpstruct.final_XYmat_labels = 'ZZZ_XYTargets5JahanFeat_hessian_Realworld.mat';
