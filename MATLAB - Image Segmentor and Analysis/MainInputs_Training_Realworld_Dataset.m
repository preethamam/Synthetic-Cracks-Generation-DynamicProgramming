...
%--------------------------------------------------------------------------
train_inpstruct.imgFolder     =  {"H:\Project MegaCRACK-RoboCRACK\Real World Data\USC PhD\Semantic Segmentation\Dataset 1 - Cracks-200\Pixel Labels\val", ...
                                  "H:\Project MegaCRACK-RoboCRACK\Real World Data\USC PhD\Semantic Segmentation\Dataset 6 - Cracks-1K (448 x 252)\Pixel Labels\val", ...
                                  "H:\Project DLCRACK\External Datasets\Yahui Liu - DeepCrack\Pixel Labels\val_crack_bmp"};

% File to save
train_inpstruct.trainImgs_filename = 'ZZZ_Val_realworld_images.mat';
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inpstruct.processed_FMatLab_filename = 'ZZZ_FeatMAT_5JahanFeat_Labels_Realworld_Valcracks_AllDS.mat';
